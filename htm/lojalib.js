...
var sF$=(function(){
  ...
  function fnShowPrice(Price,OriginalPrice,Cod,iMaxParcels,ProductID){
    ...
    if(Price!=OriginalPrice){
      ...
      sPrice+="  <div class=\"old-price\">De&nbsp; <span>"+FormatPrice(OriginalPrice,FC$.Currency)+"</span><div class=\"por\">A partir de</div></div>";
...
if(oBadge){
var sBadges="";
if(oBadge.hasAttribute("data-sale") && PrecoOri>PrecoNum)sBadges+="<div class='badgeProm' title='Oferta'>-"+ getPromocao() +"%</div>";
